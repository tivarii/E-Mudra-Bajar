...
import { orderRoute } from "../utils/httpClient";

export function SwapUI({ market }: {market: string}) {
    const [amount, setAmount] = useState('');
    const [activeTab, setActiveTab] = useState('buy');
    const [type, setType] = useState('limit');
    const [price,setPrice] = useState<string>('xyz');
    const [quantity,setQuantity] = useState<string>('abc');
    return <div>
        <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col px-3">
                    ...
                    <button type="button" className="font-semibold  focus:ring-blue-200 focus:none focus:outline-none text-center h-12 rounded-xl text-base px-4 py-2 my-4 bg-greenPrimaryButtonBackground text-greenPrimaryButtonText active:scale-98" data-rac="" onClick ={handle}>{activeTab}</button>
